...
import com.puxtech.reuters.rfa.Consumer.QuoteParser;
...
{
	private static final Log log = LogFactory.getLog(GenericOMMParser.class);
     ...
     */
    public static final void parse(OMMMsg msg, Log log)
    {
    	PrintStream ps = System.out;
		ps = LoggerPrintStream.getConsoleLogger(log);
        parseMsg(msg, ps);
    }
    ...
    static final void parseMsg(OMMMsg msg, PrintStream ps, int tabLevel)
    {
        ...
        ps.println("Receive Time: " + formater.format(new Date()));
